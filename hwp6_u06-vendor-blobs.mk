...
PRODUCT_COPY_FILES += \
    ...
    $(PATH_FILES)/bin/phy_cmd.sh:system/bin/phy_cmd.sh \
...
PRODUCT_COPY_FILES += \
    ...
    $(PATH_FILES)/lib/libbluetooth_jni.so:system/lib/libbluetooth_jni.so \
    $(PATH_FILES)/lib/libboard_param.so:system/lib/libboard_param.so \
    $(PATH_FILES)/lib/libbt-hci.so:system/lib/libbt-hci.so \
    $(PATH_FILES)/lib/libbt-utils.so:system/lib/libbt-utils.so \
...
PRODUCT_COPY_FILES += \
    ...
    $(PATH_FILES)/vendor/lib/libwvm.so:system/lib/libwvm.so \
